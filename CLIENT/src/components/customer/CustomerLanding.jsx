    ...
    <div className="min-h-screen bg-amber-50">
      ...
      <section className="py-12 bg-amber-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8 text-amber-800">Stay Updated</h2>
          <form onSubmit={handleNewsletterSubmit} className="max-w-md mx-auto">
            <div className="flex items-center">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-grow py-2 px-4 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-amber-500"
                required
              />
              <button
                type="submit"
                className="bg-amber-500 text-white py-2 px-6 rounded-r-lg hover:bg-amber-600 transition duration-300"
              >
                Subscribe
              </button>
            </div>
      ...
      {showNewsletter && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg max-w-md">
            ...
            <p className="mb-4">Get the latest updates on our delicious treats!</p>
